      ...
      <Section tone="white">
        <Container className="max-w-3xl space-y-5">
          <p className="text-sm leading-7 text-[var(--ipf-muted)]">
            There is no public self-registration login on the current IPF website. To join, submit the membership
            application. Volunteer participation is covered under Privileges.
          </p>
