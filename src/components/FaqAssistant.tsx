    ...
    <>
      ...
      {open ? (
        <div className="fixed bottom-40 right-4 z-40 w-[min(22rem,calc(100vw-2rem))] rounded-xl border border-[var(--ipf-line)] bg-[var(--ipf-paper)] p-4 shadow-xl lg:bottom-20">
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--ipf-green)]">IPF help</p>
          <p className="mt-1 text-sm text-[var(--ipf-muted)]">Answers from published IPF information.</p>
